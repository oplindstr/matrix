class UsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to jatkantappajat_path, notice: 'User was successfully created.' }
  ...
  def ensure_that_current_user
    ...
    def user_params
      params.require(:user).permit(:username, :name, :password, :password_confirmation, :activated)
    end
end
